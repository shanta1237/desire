<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ url('/dashboard/employee') }}">
     ...
     <li class="nav-item">
        ...
        <div id="collapseTwoqaa" class="collapse" aria-labelledby="headingTwoqaa" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="buttons.html">All Blogs</a>
                <a class="collapse-item" href="cards.html">Add Blogs</a>
            </div>
        </div>
    </li>
    {{-- Pages --}}
    <li class="nav-item">
        ...
        <div id="collapseTwoqaaq" class="collapse" aria-labelledby="headingTwoqaaq" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="">Services Page</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwoq" class="collapse" aria-labelledby="headingTwoq" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="buttons.html">Site Setting</a>
                <a class="collapse-item" href="cards.html">Seo Setting</a>
            </div>
        </div>
    </li>
