                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div>
                                ...
                                <form action="{{ route('employeebanner.update', $employeebanners->id) }}" method="POST">
                                    @csrf
                                    @method('patch')
                                    <div class="form-group mb-3">
                                        <label for="">Slider Name
                                        </label>
                                        <input id="name" name="title" placeholder="Title" value="{{ $employeebanners->title }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="name" name="slug"
                                            ...
                                            value="{{ $employeebanners->slug }}" type="text" class="form-control validate">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="">image
                                            <div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="summernote" class="form-control validate" rows="10" name="description"
                                            ...
                                            spellcheck="false">{{ $employeebanners->description }}</textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="condition" class="custom-select tm-select-accounts" id="category">
                                            <option selected="">{{ $employeebanners->condition }}</option>
