                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div>
                                ...
                                <form action="{{route('employeeblogcategory.update',$blogcategory->id)}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group mb-3">
                                        <label for="">category Name<span class="text-danger">*</span>
                                        </label>
                                        <input id="name" name="name" placeholder="Title" value="{{$blogcategory->name}}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="summernote" class="form-control validate" rows="8" name="description"
                                                  ...
                                                  spellcheck="false">{{$blogcategory->description}}
                                        </textarea>
                                    </div>
                                             ...
                                             <a id="lfm" data-input="thumbnail" data-preview="holder"
                                                class="btn btn-primary">
                                                 <i class="fa fa-picture-o"></i> Choose
                                                    ...
                                                    <input id="thumbnail" class="form-control" type="text" name="photo" value="{{$blogcategory->photo}}">
                                                </div>
