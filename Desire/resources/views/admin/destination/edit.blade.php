                            ...
                            <div>
                                ...
                                <form action="{{route('category.update',$category->id)}}" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="name" name="title" placeholder="Title" value="{{$category->title}}"
                                               type="text" class="form-control validate">
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="">Summary</label>
                                        <textarea id="summernote" class="form-control validate" rows="8" name="summary"
                                                  placeholder="Write some text..." required=""
                                                  spellcheck="false">{{$category->summary}}
                                        </textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3 {{$category->is_parent==1 ? 'd-none':''}}" id="parent_cat_div">
                                            <label for="">Parent category</label>
                                            <select name="parent_id" class="custom-select tm-select-accounts" id="category">
